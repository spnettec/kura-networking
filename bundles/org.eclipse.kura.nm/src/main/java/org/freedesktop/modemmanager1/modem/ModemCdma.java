...
public interface ModemCdma extends DBusInterface {
    ...
    void Activate(String carrierCode);

    void ActivateManual(Map<String, Variant<?>> properties);
    ...
    public static class ActivationStateChanged extends DBusSignal {
        ...
        public ActivationStateChanged(String path, UInt32 activationState, UInt32 activationError, Map<String, Variant<?>> statusChanges) throws DBusException {
                super(path, activationState, activationError, statusChanges);        this.activationState = activationState;
