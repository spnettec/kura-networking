...
public interface Oma extends DBusInterface {
    ...
    void Setup(UInt32 features);

    void StartClientInitiatedSession(UInt32 sessionType);

    void AcceptNetworkInitiatedSession(UInt32 sessionId, boolean accept);
    ...
    public static class SessionStateChanged extends DBusSignal {
        ...
        public SessionStateChanged(String path, int oldSessionState, int newSessionState, UInt32 sessionStateFailedReason) throws DBusException {
                super(path, oldSessionState, newSessionState, sessionStateFailedReason);        this.oldSessionState = oldSessionState;
                this.newSessionState = newSessionState;
                this.sessionStateFailedReason = sessionStateFailedReason;
        }
